...
function SingUpPresentations() {
   ...
   async function handleUserInput(e) {
    ...
    async function handleFormSubmit(e) {
        ...
        console.log("this is the handleFormSubmit" ,signUpState); // this is work
        ...
        <section className="text-gray-600 body-font">
            <div className="flex flex-wrap items-center h-screen px-10 py-6 mx-auto">
                ...
                <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0">
                    ...
                    <p className="mt-3 text-xs text-gray-500">Already have an account? <Link to="/login" className="text-yellow-500">Login</Link></p>
                </form>
            </div>
        </section>
    </>
...
export default SingUpPresentations;
